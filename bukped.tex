...
\renewcommand{\tableofcontents}{%
  ...
  \pagestyle{empty}
  \thispagestyle{empty}
  \noindent\makebox[\paperwidth]{\hfill\Large\bfseries DAFTAR ISI\hfill}
  \vspace{0.5cm}
...
\renewcommand{\listoffigures}{%
  ...
  \pagestyle{empty}
  \thispagestyle{empty}
  \noindent\makebox[\paperwidth]{\hfill\Large\bfseries DAFTAR GAMBAR\hfill}
  \vspace{0.5cm}
  \@starttoc{lof}
  \clearpage
  \pagestyle{fancy}
...
\renewcommand{\listoftables}{%
  ...
  \pagestyle{empty}
  \thispagestyle{empty}
  \noindent\makebox[\paperwidth]{\hfill\Large\bfseries DAFTAR TABEL\hfill}
  \vspace{0.5cm}
  \@starttoc{lot}
  \clearpage
  \pagestyle{fancy}
